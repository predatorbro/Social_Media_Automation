                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${colorClass === 'instagram' ? 'bg-instagram/10' :
                            colorClass === 'twitter' ? 'bg-twitter/10' :
                              colorClass === 'linkedin' ? 'bg-linkedin/10' :
                                colorClass === 'facebook' ? 'bg-facebook/10' : 'bg-muted'
                            }`}>
                            <Icon className={`w-6 h-6 ${colorClass === 'instagram' ? 'text-instagram' :
